...
public class WechatUserFeignController {
     ...
     */
    @GetMapping
    public ResultVO<WechatUserWebVO> getWechatUser(@RequestParam Long wechatUserId) {
     ...
     */
    @GetMapping("list")
    public ResultVO<List<WechatUserWebVO>> listWechatUser(@RequestParam Set<Long> wechatUserIds) {
