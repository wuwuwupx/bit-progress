package com.bitprogress.startermvccloud.filter;
...
import com.bitprogress.corebase.service.UserContextMaintenanceService;
import com.bitprogress.corebase.util.UserUtils;
...
public class UserFilter implements Filter, UserContextMaintenanceService {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            // 获取请求来源
            RequestSource requestSource = requestInformationService.getRequestSource();
            ...
            switch (requestSource) {
                case GATEWAY -> {
                    ...
                    // 设置用户上下文
                    RequestType requestType = requestInformationService.getRequestType();
                    if (RequestType.USER_REQUEST.equals(requestType)) {
                        DispatcherContextService.markUserRequest();
                        UserInfo userInfo = requestInformationService.getUserInfo();
