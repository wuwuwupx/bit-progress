package com.bitprogress.startermvcfull.context.route.impl;

import com.bitprogress.securityroute.entity.ApiRoute;
import com.bitprogress.startermvcfull.context.route.RouteContextService;

import java.util.Set;

public class TicketRouteContextService implements RouteContextService<ApiRoute> {
